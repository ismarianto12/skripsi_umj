<div class="card">
    <div class="card-header">
        <div class="card-title">Edit Master Data Proyek</div>
    </div>
    <div class="ket"></div>
    ...
    <form id="exampleValidation" method="POST" class="simpan">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-12">
                    <textarea class="form-control" name="lokasi" rows="6" cols="8">{{ $lokasi }}</textarea>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input type="date" class="form-control" id="tgl_mulai" name="tgl_mulai" value="{{ $tgl_mulai }}">
                </div>
...
<script type="text/javascript">
    ...
    $(function() {
        $('.simpan').on('submit', function(e) {
            ...
            // alert('asa');
            $.ajax({
                url: "{{ route('master.tmproyek.update', $id) }}",
                method: "PUT",
                data: $(this).serialize(),
                chace: false,
                async: false,
