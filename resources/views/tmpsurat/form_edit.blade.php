                ...
                <div class="col-md-12">
                    <table class="table table-striped table-sm">
                        ...
                        <tr>
                            ...
                            <th></th>
                            <th><input class="form-control number form-sm" name="penawaran_th_1"
                                    value="{{ $penawaran_th_1 }}" type="text" placeholder="1">
                            </th>
                            <th><input class="form-control number form-sm" name="penawaran_th_2"
                                    value="{{ $penawaran_th_2 }}" type="text" placeholder="2"></th>
                            <th><input class="form-control number form-sm" name="penawaran_th_3"
                                    value="{{ $penawaran_th_3 }}" type="text" placeholder="3"></th>
                            <th><input class="form-control number form-sm" name="penawaran_th_4"
                                    value="{{ $penawaran_th_4 }}" type="text" placeholder="4"></th>
                        </tr>
                        <tr>
                            <th>Pemilik Telkomsel</th>
                            <th></th>
                            <th><input class="form-control number form-sm" name="pemilik_1" value="{{ $pemilik_1 }}"
                                    type="text" placeholder="1">
                            </th>
                            <th><input class="form-control number form-sm" name="pemilik_2" value="{{ $pemilik_2 }}"
                                    type="text" placeholder="2">
                            </th>
                            <th><input class="form-control number form-sm" name="pemilik_3" value="{{ $pemilik_3 }}"
                                    type="text" placeholder="3">
                            </th>
                            <th><input class="form-control number form-sm" name="pemilik_4" value="{{ $pemilik_4 }}"
...
<script type="text/javascript">
    $(function() {
        $('.simpan').on('submit', function(e) {
            e.preventDefault();
            $.ajax({
                url: "{{ route('master.tmpsurat.update', $id) }}",
                method: "PUT",
                data: $(this).serialize(),
                chace: false,
                async: false,
