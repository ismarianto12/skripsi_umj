    ...
    <form id="exampleValidation" method="POST" class="simpan">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    {{-- <input type="text" name="jenis_surat_id" class="form-control" /> --}}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="site_id" value="{{ $site_id }}" class="form-control" />
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="nomor_pks" value="{{ $nomor_pks }}" class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-3">ALAMAT SITE</label>
                <div class="col-md-6">
                    <input type="text" name="alamat_site" value="{{ $alamat_site }}" class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-3">PIC PEMILIK LAHAN</label>
                <div class="col-md-6">
                    <input type="text" name="pic_pemilik_lahan" value="{{ $pic_pemilik_lahan }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="nilai_sewa_tahun" value="{{ $nilai_sewa_tahun }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="date" name="periode_sewa_awal" value="{{ $periode_sewa_awal }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="date" name="periode_sewa_akhir" value="{{ $periode_sewa_akhir }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="nama_negosiator" value="{{ $nama_negosiator }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="email_negosiator" value="{{ $email_negosiator }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="nomor_hp_negosiator" value="{{ $nomor_hp_negosiator }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="revenue_3_bulan" value="{{ $revenue_3_bulan }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="revenue_2_bulan" value="{{ $revenue_2_bulan }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="revenue_1_bulan" value="{{ $revenue_1_bulan }}"
                        class="form-control" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="harga_patokan" value="{{ $harga_patokan }}" class="form-control" />
                </div>
            </div>
