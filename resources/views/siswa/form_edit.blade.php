        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group"><label>Nama Lengkap</label><input type="text" class="form-control"
                        id="nama" name="nama" placeholder="Nama Lengkap" value="{{ $data->nama }}" /></div>

                <div class="form-group"><label>Email</label><input type="text" class="form-control" id="email"
                        name="email" placeholder="Email" value="{{ $data->email }}" /></div>

                <div class="form-group"><label>Nomor Hp</label><input type="number" class="form-control"
                        value="{{ $data->no_hp }}" id="no_hp" name="no_hp" placeholder="Nomor Hp"
                        value="" /></div>
                ...
                <div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="provinsi">
                            ...
                            <option data="19" value="KEPULAUAN BANGKA BELITUNG">KEPULAUAN BANGKA BELITUNG </option>
                ...
                <div class="form-group">
                    <label>Alamat</label>
                    <textarea rows="4" class="form-control" id="alamat" name="alamat" placeholder="Alamat Lengkap">{{ $data->alamat }}</textarea>
                </div>
                <div class="form-group"><label>Nama Ayah</label> <input type="text" class="form-control"
                        id="nama_ayah" name="nama_ayah" placeholder="Nama Orang Tua" {{ $data->nama_ayah }}></div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group"><label>Kelas</label>
                    <select class="form-control" id="datakelas" name="datakelas">
                        ...
                        @foreach (Properti_app::getKelas() as $kelasdata)
                ...
                <div class="form-group row">
                    <div class="col-sm-3"><img width="100" height="85" id="preview"
                            class="img-thumbnail" /></div>
                    <div class="col-sm-9">
                        <input hidden="" type="file" name="img_siswa" class="file" accept="image/*"
                            id="imgInp" value="" />
                        <div class="input-group my-3">
                            <input type="text" class="form-control" disabled="" placeholder="Foto siswa"
                                id="file" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input hidden="" type="file" name="img_kk" class="file1" accept="image/*"
                            id="imgInp1" />
                        <div class="input-group my-3">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input hidden="" type="file" name="img_ijazah" class="file2" accept="image/*"
                            id="imgInp2" />
                        <div class="input-group my-3">
                            <input type="text" class="form-control" disabled="" placeholder="Foto Ijazah"
                                id="file2" />
                            <div class="input-group-append"><button type="button"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input hidden="" type="file" name="img_ktp" class="file3" accept="image/*"
                            id="imgInp3" />
                        <div class="input-group my-3">
                            <input type="text" class="form-control" disabled="" placeholder="Foto Akte / KTP"
                                id="file3" />
                            <div class="input-group-append"><button type="button"
        ...
        <div class="_stepbackgroundalkdmsaldkma exssubmitform pt-3 form-group row">
            <div class="col-md-12 text-center">
                <button type="submit" class="btn-block btn btn-success"
                    ...
                    class="btn-block btn btn-danger" style="width: 40%;">Batal</button>
            </div>
        </div>
    </form>
...
<script type="text/javascript">
    $(function() {
        $('.simpan').on('submit', function(e) {
            ...
            // alert('asa');
            $.ajax({
                url: "{{ route('master.siswa.update', $id) }}",
                method: "PUT",
                data: $(this).serialize(),
                chace: false,
                async: false,
