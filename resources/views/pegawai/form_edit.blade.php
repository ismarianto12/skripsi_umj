    ...
    <form id="exampleValidation" method="POST" class="simpan">
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="kode_rap" name="kode_rap" value="{{ $kode_rap }}">
                </div>

                <label for="name" class="col-md-2 text-left">Nama RAP <span class="required-label">*</span></label>
                <div class="col-md-4">
                    <input type="text" class="form-control" id="nama_rap" name="nama_rap" value="{{ $nama_rap }}">
                </div>
            </div>
        </div>
