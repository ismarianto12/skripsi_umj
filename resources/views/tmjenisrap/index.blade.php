    ...
    <script>
        ...
        function del() {
            ...
            if (c.length == 0) {
                ...
                $.post("{{ route('master.tmjenisrap.destroy', ':id') }}", {
                    '_method': 'DELETE',
                    'id': c
                }, function(data) {
        ...
        $(function() {
            $('#add_data').on('click', function() {
                ...
                addUrl = '{{ route('master.tmjenisrap.create') }}';
            ...
            $('#datatable').on('click', '#edit', function(e) {
                ...
                $('#formmodal').modal('show');
                id = $(this).data('id');
                addUrl = '{{ route('master.tmjenisrap.edit', ':id') }}'.replace(':id', id);
